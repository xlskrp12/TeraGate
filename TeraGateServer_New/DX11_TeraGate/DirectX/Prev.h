...
#include<WS2tcpip.h>
#include"..\..\TeraGateServer_New\protocol.h"
...
#include<d3dcommon.h>
#include<DXGI.h>
#include<atlstr.h>      // mfc외 프로젝트에서 cstring사용시
// #include<DirectXMath.h> // XMFLOAT3 구조체 사용가능..하긴 한데 그냥 D3DX10math.h의 D3DXVECTOR3 구조체 쓰자.. 연산자 오버로딩도 이것저것 되있다.
#define CLIENT_WIDTH  800//1600//1960//1280
#define CLIENT_HEIGHT 600//900//1080//720
...
const float SCREEN_NEAR   = 0.2f;
const float FOV           = DEGREE_TO_RADIAN(45);
